...
using ComplaintsManagement.Application.Services;
...
using ComplaintsManagement.Application;
using Microsoft.AspNetCore.Http;

namespace ComplaintsManagement.WebHost
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.OAuthAppName("Swagger Authentication Api");
            });
            app.UseRouting();
